---------------------------- MODULE PaxosCommit ----------------------------
(***************************************************************************)
(* reference 4 (Paxos Commit with liveness properties)                     *)
(*                                                                         *)
...
PCSpec == /\ PCInit
          ...
          /\ WF_vars(PCDecide)
          /\ \A r \in RM: /\ WF_vars(RMRcvCommitMsg(r))
                          /\ WF_vars(RMRcvAbortMsg(r))
  (*************************************************************************)
...
\* Last modified Fri Nov 23 22:21:46 EST 2018 by steve
